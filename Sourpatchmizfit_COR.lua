...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'DeathPenalty_M', 'DeathPenalty_R', 'Fomalhaut_M', 'Fomalhaut_R', 'Ataktos'}
    ...
    gear.JSE_Cape_SNP = { name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','Rng.Acc.+5','"Snapshot"+10',}}
    gear.JSE_Cape_LS = { name="Camulus's Mantle", augments={'AGI+20','Mag.Acc.+20 Mag.Dmg.+20','"Weapon Skill Damage"+10',}}
    gear.JSE_Cape_SB = { name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+5','Weapon skill damage +10%',}}
...
function init_gear_sets()
    ...
    -- (10% Snapshot from JP Gifts)      snapshot/rapid shot/recycle
    sets.precast.RA = {
        ammo=gear.RAbullet,
        head="Chasseur's Tricorne +3", --0/18/0
        body="Laksamana's Frac +3", --0/20/19
        hands="Carmine Finger Gauntlets +1", --8/11/0
        legs="Adhemar Kecks +1", --10/13/16
        feet="Meg. Jam. +2", --10/0/0
        neck="Comm. Charm +2", --4/0/0
        back=gear.JSE_Cape_SNP, --10/0/0
        waist="Yemaya Belt", --0/5/0
        ring1="Dingir Ring", --0/0/10
        ring2="Crepuscular Ring", --3/0/0
        ear1="Chasseur's Earring +1", --0/0/11
        } --44(10)/57/46
    ...
    sets.engaged.DW.LowAcc = sets.engaged

    sets.engaged.DW.MidAcc = sets.engaged

    sets.engaged.DW.HighAcc = sets.engaged

    sets.engaged.DW.STP = sets.engaged

    -- 15% Magic Haste (67% DW to cap)
    sets.engaged.DW.LowHaste = sets.engaged.DW

    sets.engaged.DW.LowAcc.LowHaste = sets.engaged.DW

    sets.engaged.DW.MidAcc.LowHaste = sets.engaged.DW

    sets.engaged.DW.HighAcc.LowHaste = sets.engaged.DW

    sets.engaged.DW.STP.LowHaste = sets.engaged.DW

    -- 30% Magic Haste (56% DW to cap)
    sets.engaged.DW.MidHaste = sets.engaged

    sets.engaged.DW.LowAcc.MidHaste = sets.engaged.DW.MidHaste

    sets.engaged.DW.MidAcc.MidHaste = sets.engaged.DW.MidHaste

    sets.engaged.DW.HighAcc.MidHaste = sets.engaged.DW.MidHaste

    sets.engaged.DW.STP.MidHaste = sets.engaged.DW.MidHaste

    -- 35% Magic Haste (51% DW to cap)
    sets.engaged.DW.HighHaste = sets.engaged

    sets.engaged.DW.LowAcc.HighHaste = sets.engaged.DW.HighHaste

    sets.engaged.DW.MidAcc.HighHaste = sets.engaged.DW.HighHaste

    sets.engaged.DW.HighAcc.HighHaste = sets.engaged.DW.HighHaste

    sets.engaged.DW.STP.HighHaste = sets.engaged.DW.HighHaste

    -- 45% Magic Haste (36% DW to cap)
    sets.engaged.DW.MaxHaste = sets.engaged

    sets.engaged.DW.LowAcc.MaxHaste = sets.engaged.DW.MaxHaste

    sets.engaged.DW.MidAcc.MaxHaste = sets.engaged.DW.MaxHaste

    sets.engaged.DW.HighAcc.MaxHaste = sets.engaged.DW.MaxHaste

    sets.engaged.DW.STP.MaxHaste = sets.engaged.DW.MaxHaste
    ...
    sets.FullTP = {ear1="Hecate's Earring"}
    sets.Obi = {waist="Hachirin-no-Obi"}
    -- sets.CP = {back="Mecisto. Mantle"}
    sets.Reive = {neck="Adoulin's Refuge +1"}

    sets.TreasureHunter = {head="White Rarab Cap +1", legs="Volte Hose", waist="Chaac Belt"}

    sets.DeathPenalty_M = {main="Rostam", sub="Gleti's Knife", ranged="Death Penalty"}
    sets.DeathPenalty_M.Acc = {main="Rostam", sub="Gleti's Knife", ranged="Death Penalty"}
    sets.DeathPenalty_R = {main="Naegling", sub="Gleti's Knife", ranged="Death Penalty"}
    ...
    sets.Fomalhaut_M = {main="Rostam", sub="Tauret", ranged="Fomalhaut"}
    sets.Fomalhaut_M.Acc = {main="Rostam", sub="Tauret", ranged="Fomalhaut"}
