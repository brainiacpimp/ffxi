...
function init_gear_sets()
    ...
    --    /RDM --15
        ammo="Sapience Orb", --2
        head="Welkin Crown", --11
        body="Chironic Doublet", --13
        hands="Jhakri Cuffs +2", --9
        legs="Lengo Pants", --8
    ...
    sets.precast.FC.Impact = set_combine(sets.precast.FC, {head=empty, body="Crepusclar Cloak", waist="Shinjutsu-no-Obi +1"})
