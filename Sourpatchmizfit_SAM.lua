...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Knobkierrie",
        head="Valorous Mask",neck="Samurai's Nodowa +1",ear1="Thrud Earring",ear2="Moonshade Earring",
        body="Valorous Mail",hands="Mpaca's Gloves",ring1="Ilabrat Ring",ring2="Regal Ring",
        back="Phalangite Mantle",waist="Fotia Belt",legs="Hizamaru Hizayoroi +1",feet="Thereoid Greaves"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        head="Loess Barbuta +1",neck="Bathy Choker",ear1="Infused Earring",ear2="Tuisto Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Chirich Ring +1",ring2="Warp Ring",
        back="Reiki Cloak",waist="Flume Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
    ...
    sets.engaged = {ammo="Coiste Bodhar",
        head="Mpaca's Cap",neck="Samurai's Nodowa +1",ear1="Telos Earring",ear2="Dignitary's Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Ilabrat Ring",ring2="Niqmaddu Ring",
        back="Kayapa Cape",waist="Ioskeha Belt +1",legs="Mpaca's Hose",feet="Mpaca's Boots"}
