...
function init_gear_sets()
    ...
    sets.precast.FC = {
        head="Welkin Crown", --6
        body="Vrikodara Jupon", --14
        hands="Leyline Gloves", --7
        legs="Lengo Pants", --8
        feet="Navon Crackows", --6
        neck="Orunmila's Torque", --5
        ear1="Enchanter's Earring +1", --2
        ear2="Etiolation Earring", --1
        ring1="Rahab Ring", --5
        ring2="Kishar Ring", --4
        back="Swith Cape +1", --10
        waist="Witful Belt", --5
        }
    ...
    sets.precast.FC.SongPlaceholder = set_combine(sets.precast.FC.BardSong, {range="Blurred Harp +1"})
    ...
    sets.midcast.SongPlaceholder = set_combine(sets.midcast.SongEnhancing, {range="Blurred Harp +1"})
    ...
    sets.Carnwenhan = {main="Gleti's Knife", sub="Centovente"}
    sets.Twashtar = {main="Twashtar", sub="Centovente"}
    sets.Tauret = {main="Tauret", sub="Centovente"}
