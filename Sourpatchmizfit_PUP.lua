...
function init_gear_sets()
    ...
    sets.precast.FC = {head="Herculean Helm",neck="Baetyl Pendant",ear2="Loquacious Earring",}
    ...
    sets.precast.WS = {
        ...
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Regal Ring",ring2="Niqmaddu Ring",
    ...
    sets.idle = {
        head="Nyame Helm",neck="Empath Necklace",ear1="Infused Earring",ear2="Handler's Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Shneddick Ring",ring2="Warp Ring",
        back="Boxer's Mantle",waist="Moonbow Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.idle.Pet.Engaged = {
        set_combine(sets.idle.Pet, {neck="Shulmanu Collar",ear1="Kyrene's Earring", ring1="Varar Ring +1", ring2="Varar Ring +1",
         back="Dispersal Mantle", waist="Klouskap Sash"})}
    ...
    -- Normal melee group
    sets.engaged = {
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Telos Earring",ear2="Mache Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Regal Ring",ring2="Niqmaddu Ring",
        back="Dispersal Mantle",waist="Moonbow Belt",legs="Mpaca's Hose",feet="Malignance Boots"}
    --sets.engaged.Acc = {
