...
function init_gear_sets()
    ...
    sets.precast.JA['Chi Blast'] = {
        ammo="Hydrocera",
        head="Mpaca's Cap", neck="Monk's Nodowa +1", ear1="Influx Earring", ear2="Flashward Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Stikini Ring +1", ring2="Stikini Ring +1",
        back="Xucau Mantle",waist="Luminary Sash",legs="Mpaca's Hose",feet="Mpaca's Boots"}
    ...
    sets.precast.WS = {ammo="Crepuscular Pebble",
        head="Mpaca's Cap",neck="Monk's Nodowa +1",ear1="Sherida Earring",ear2="Moonshade Earring",
        body="Tatenashi Haramaki +1",hands="Mpaca's Gloves",ring1="Niqmaddu Ring",ring2="Hetairoi Ring",
        back="Segomo's Mantle",waist="Fotia Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
    sets.precast.WSAcc = {}
    sets.precast.WSMod = {}
    sets.precast.MaxTP = {}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        head="Malignance Chapeau",neck="Bathy Choker",ear1="Infused Earring",ear2="Genmei Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Defending Ring",ring2="Shneddick Ring",
        back="Xucau Mantle",waist="Anguinus Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
    ...
    sets.engaged = {ammo="Aurgelmir Orb",
        head="Malignance Chapeau",neck="Monk's Nodowa +1",ear1="Sherida Earring",ear2="Mache Earring +1",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Niqmaddu Ring",ring2="Gere Ring",
        back="Segomo's Mantle",waist="Moonbow Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
