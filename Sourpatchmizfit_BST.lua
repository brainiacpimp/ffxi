...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Aurgelmir Orb",
        ...
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Karieyh Ring +1",ring2="Regal Ring",
    ...
    -- IDLE SETS
    sets.idle = {
        head="Gleti's Mask",neck="Shulmanu Collar",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Varar Ring +1",ring2="Vavar Ring +1",
        back="Ferine Mantle",waist="Klouskap Sash",legs="Gleti's Breeches",feet="Gleti's Boots"}
    ...
    sets.engaged = {ammo="Coiste Bodhar",
        head="Malignance Chapeau",neck="Anu Torque",ear1="Sroda Earring",ear2="Nukumi Earring +1",
        body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Ilabrat Ring",ring2="Regal Ring",
        back="Mecistopins Mantle",waist="Windbuffet Belt +1",legs="Gleti's Breeches",feet="Gleti's Boots"}
    ...
    sets.engaged.Pet = {ammo="Coiste Bodhar",
        head="Malignance Chapeau",neck="Shulmanu Collar",ear1="Sroda Earring",ear2="Nukumi Earring +1",
        body="Gleti's Cuirass",hands="Gleti's Gauntlets",ring1="Ilabrat Ring",ring2="Regal Ring",
        back="Mecistopins Mantle",waist="Windbuffet Belt +1",legs="Gleti's Breeches",feet="Gleti's Boots"
    }
