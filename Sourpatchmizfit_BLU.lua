...
function init_gear_sets()
    ...
    sets.precast.JA['Chain Affinity'] = {head="Hashi. Kavuk +3",feet="Assim. Charuqs +1"}
    ...
    sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {
        ...
        ring2="Epona's Ring",
        back={name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','ACC+10','Critical hit rate +10%',}},
        })
    ...
    sets.midcast['Blue Magic'].MagicAccuracy = {
        ammo="Hydrocera", -- +6
        head="Hashishin Kavuk +3",  -- +61
        body="Hashishin Mintan +3",  -- +64
        hands="Hashishin Bazubands +3",  -- +62
        legs="Hashishin Tayt +3",  -- +63
        feet="Hashishin Basmak +3",  -- +60
        neck="Mirage Stole +2", -- +25
        ear1="Digni. Earring", -- +10
        ear2="Hashishin Earring +1", -- +12
        ring1="Stikini Ring +1", -- +11
        ring2="Stikini Ring +1", -- +11
        back="Cornflower Cape", -- +15
        waist="Luminary Sash", -- +10
        --head="Volte Cap", hands=gear.Herc_TH_hands, feet="Volte Boots" -- TH Tag
        } -- +410

    sets.midcast['Blue Magic'].Breath = set_combine(sets.midcast['Blue Magic'].Magical, {ammo="Mavi Tathlum",head="Luh. Keffiyeh +1", waist="Glassblower's Belt"})
    ...
    sets.midcast.Phalanx = set_combine(sets.midcast.EnhancingDuration, {
        head="Herculean Helm", --5
        body="Herculean Vest", --2
        hands="Herculean Gloves", --2
        legs="Herculean Gloves", --4(10)
    ...
    sets.idle.Learning = set_combine(sets.idle, {hands="Assimilator's Bazubands +1"})
    ...
    sets.engaged.DW.LowAcc = sets.engaged.DW

    sets.engaged.DW.MidAcc = sets.engaged.DW

    sets.engaged.DW.HighAcc = sets.engaged.DW

    sets.engaged.DW.STP = sets.engaged.DW
    ...
    sets.engaged.DW.LowAcc.MidHaste = sets.engaged.DW

    sets.engaged.DW.MidAcc.MidHaste = sets.engaged.DW

    sets.engaged.DW.HighAcc.MidHaste = sets.engaged.DW

    sets.engaged.DW.STP.MidHaste = sets.engaged.DW

    -- 35% Magic Haste (51% DW to cap)
    sets.engaged.DW.HighHaste = sets.engaged.DW

    sets.engaged.DW.LowAcc.HighHaste = sets.engaged.DW

    sets.engaged.DW.MidAcc.HighHaste = sets.engaged.DW

    sets.engaged.DW.HighAcc.HighHaste = sets.engaged.DW

    sets.engaged.DW.STP.HighHaste = sets.engaged.DW

    -- 45% Magic Haste (36% DW to cap)
    sets.engaged.DW.MaxHaste = sets.engaged.DW

    sets.engaged.DW.LowAcc.MaxHaste = sets.engaged.DW

    sets.engaged.DW.MidAcc.MaxHaste = sets.engaged.DW

    sets.engaged.DW.HighAcc.MaxHaste = sets.engaged.DW

    sets.engaged.DW.STP.MaxHaste = sets.engaged.DW
    ...
    sets.Almace = {main="Naegling", sub="Sakpata's Sword"}
