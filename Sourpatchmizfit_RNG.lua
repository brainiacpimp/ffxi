...
function init_gear_sets()
	...
	sets.precast.FC = {
		head="Herculean Helm",neck="Orunmila's Torque",ear1="Enchanter's Earring",ear2="Loquacious Earring",
	...
	sets.precast.RA = {
		...
		body="Pursuer's Doublet",hands="Carmine Finger Guantlets +1",ring1="Crepuscular Ring",
	...
	sets.precast.WS = {
		...
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Regal Ring",ring2="Ifrit Ring",
    ...
    sets.precast.WS['Trueflight'] = {ammo="Orichalcum Bullet",
        ...
        back="Aput Mantle",waist="Sveltesse Gouriz +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	...
	sets.midcast.RA = {
		head="Meghanada Visor +1",neck="Ocachi Gorget",ear1="Telos earring",ear2="Neritic Earring",
		body="Adhemar Jacket +1",hands="Meghanada Gloves +2",ring1="Regal Ring",ring2="Dingir Ring",
		back="Lutian Cape",waist="Reiki Yotai",legs="Nahtirah Trousers",feet="Thereoid Greaves"}
	...
	sets.idle = {
		...
		back="Reiki Cloak",waist="Flume Belt",legs="Nyame Flanchard",feet="Malignance Boots"}
	...
	sets.engaged = {
		...
		back="Mecistopins Mantle",waist="Grunfeld Rope",legs="Samnuha Tights",feet="Malignance Boots"}
